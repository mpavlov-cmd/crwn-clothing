...
import {authOperationFailure, emailSignUpSuccess, signInSuccess, signOutUserSuccess} from "./user.action";
...
function* getSnapshotFromUserAuth(userAuth, additionalInformation) {
    try {
        ...
        yield put(authOperationFailure(error));
    }
}
...
function* emailAndPasswordSignUp({payload}) {
